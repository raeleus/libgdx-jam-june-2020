...
public class MoveMarioBlast extends MoveSpecialTemplate {
    ...
    public void update(PerformerEntity performer, float delta) {
        ...
        if (performer.fireProjectileEvent) {
            ...
            projectile.skinName = ProjectileSkinName.MARIO_FIREBALL;
        ...
        if (performer.soundEvent) {
            Sound sound = assetManager.get("sfx/move-blast.mp3");
            sound.play();
        }
    }
}
